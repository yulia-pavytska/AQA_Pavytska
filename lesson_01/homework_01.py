...
pears = apples + 5
plums = apples - 2
all_tree = apples + pears + plums
print(f"Всього дерев у саду: {all_tree}")
...
temperature -= 10
temperature += 4
print(f"Температура надвечір: {temperature}°C")
...
print(f"Сьогодні у театральному гуртку: {total_children_today} дітей")
...
print(f"Загальна вартість усіх книжок: {total_price} грн")
